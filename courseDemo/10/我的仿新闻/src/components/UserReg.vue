<template>
	<div class="content">
	    ...
	    <div class="footbox">
	        <input type="button" v-on:click="register" value="注 册" class="login-btn" />
...
<script>
	export default{
		mounted(){
			this.$http.post("https://sdk.yunduoketang.cn/appApi/company/welcome").then(function(res){
                    console.log('res',res)
				})
		},
		methods:{
			register(){
				// this.$http.post({
				// 	url:'http://sdk.yunduoketang.cn/appApi/user/register',
				// 	methods:'post',
				// 	data:{
